...
class EmployeeTimeSheetAPI extends EndPoint
{
   ...
   protected function getEmployeeService()
    ...
    public function saveEmployeeTimeSheets()
    {
        ...
        $statusArray = $this->getTimesheetService()->createTimesheets($startDate, $filters[self::PARAMETER_ID]);
        ...
        switch ($statusArray['state']) {
            ...
            case $statusArray['state'] == 2:
                ...
                return new Response(array('success' => 'Successfully Created','timesheetId'=>$statusArray['id']));
