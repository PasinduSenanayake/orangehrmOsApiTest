<?php  //[STAMP] 011577fa170c95b19f4814062a20c2be
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::getIssueToken()
     */
    public function getIssueToken($I) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getIssueToken', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::insertDb()
     */
    public function insertDb($I, $testName) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('insertDb', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::deleteFromDatabase()
     */
